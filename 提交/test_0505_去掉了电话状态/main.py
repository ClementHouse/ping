...
def lgb_predict():
    ...
    X_train = total_data[["SPEED", "hour", "weekday", "LONGITUDE", "LATITUDE", "DIRECTION", "HEIGHT"]]
    ...
    params = {
        ...
        'metric': {'l2', 'auc'},
        'num_leaves': 31,              #这些参数其实也应该交叉验证调的，都没弄
        'learning_rate': 0.05,
    ...
    out["y_pred"] = gbm.predict(
        X_test[["SPEED", "hour", "weekday", "LONGITUDE", "LATITUDE", "DIRECTION", "HEIGHT"]],
